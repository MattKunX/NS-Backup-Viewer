...
class VendorpaymentRecord extends Record
{
    public function itemsTableHtml(){
        $items = $this->getTable('VENDORPAYMENT_item',array('cashsale_InternalId'=>$this->id),
    ...
    public function messagesTableHtml(){
        $messages = $this->getVENDORPAYMENT_messagesTable(array('vendorpayment_InternalId'=>$this->id),
    ...
    public function notesTableHtml($num){
        ...
        $notes = $this->getNOTETable(array('transaction'=>'Vendor Payment #'.$num),
    ...
    public function salesteamTableHtml(){
        ...
        $salesreps = $this->getTable('VENDORPAYMENT_salesteam',array('vendorpayment_InternalId'=>$this->id),
    ...
    public function giftcertTableHtml(){
        ...
        $giftcerts = $this->getTable('VENDORPAYMENT_giftcertredemption',array('vendorpayment_InternalId'=>$this->id),
