...
class InvoiceRecord extends Record
{
    public function itemsTableHtml(){
        $items = $this->getTable('INVOICE_item',array('invoice_InternalId'=>$this->id),
    ...
    public function relatedTableHtml($num){
        ...
        $transactions['returnauthorization']['data'] = $this->getRETURNAUTHORIZATIONTable(array('createdfrom'=>'Invoice #'.$num),
    ...
    public function messagesTableHtml(){
        $messages = $this->getINVOICE_messagesTable(array('invoice_InternalId'=>$this->id),
    ...
    public function notesTableHtml($num){
        ...
        $notes = $this->getNOTETable(array('transaction'=>'Invoice #'.$num),
    ...
    public function salesteamTableHtml(){
        ...
        $salesreps = $this->getTable('INVOICE_salesteam',array('invoice_InternalId'=>$this->id),
    ...
    public function giftcertTableHtml(){
        ...
        $giftcerts = $this->getTable('INVOICE_giftcertredemption',array('invoice_InternalId'=>$this->id),
