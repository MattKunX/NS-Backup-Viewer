...
return array(
        ...
        'routes' => array(
            ...
            'tasks' => array(
                ...
                'options' => array(
                    ...
                    'defaults' => array(
                        'controller' => 'Application\Controller\Tasks',
                        'action'     => 'index',
                    ),
                ),
                'may_terminate' => true,
            ...
            // using the path matrix/dashboard/:action
            'dashboard' => array(
                'type'    => 'Segment',
                'options' => array(
                    ...
                    'defaults' => array(
                        //'__NAMESPACE__' => 'Application\Controller\Dashboard',
                        'controller'    => 'Application\Controller\Dashboard',
                        'action'        => 'index',
                    ),
                ),
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            'Application\Controller\Tasks' => Controller\TasksController::class
        ),
    ),
    'view_manager' => array(
